.PHONY: build ncm_cleaner mp3_lister mp3_db list_exporter list_emotion install fcm migrate_tankcn
...
migrate_tankcn:
	...
	go install -ldflags="-s -w" -tags=jsoniter ./cmd/migrate_tankcn
