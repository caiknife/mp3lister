...
func newCar(db *gorm.DB, opts ...gen.DOOption) car {
	...
	_car.ID = field.NewUint64(tableName, "id")
	...
	_car.Type = field.NewString(tableName, "type")
	_car.Fuel = field.NewString(tableName, "fuel")
	_car.Transmission = field.NewString(tableName, "transmission")
	_car.Brand = field.NewString(tableName, "brand")
	_car.Model = field.NewString(tableName, "model")
	_car.Year = field.NewInt32(tableName, "year")
...
type car struct {
	...
	Type         field.String // 车辆类型
	Fuel         field.String // 燃料
	Transmission field.String // 传动结构
	Brand        field.String // 品牌
	Model        field.String // 型号
	Year         field.Int32  // 生产年份
...
func (c *car) updateTableName(table string) *car {
	...
	c.Fuel = field.NewString(table, "fuel")
	c.Transmission = field.NewString(table, "transmission")
...
func (c *car) fillFieldMap() {
	...
	c.fieldMap["fuel"] = c.Fuel
	c.fieldMap["transmission"] = c.Transmission
